...
(function() {
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 100000, "filename": "/randfile"}], "remote_package_size": 100000, "package_uuid": "aae503cf-7e9b-4cfe-bc2c-81c51e131fdb"});
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'ldpc-wasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'ldpc-wasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'ldpc-wasm.temp.asm.js';
...
STATICTOP = STATIC_BASE + 108192;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "ldpc-wasm.html.mem" : null;




var STATIC_BUMP = 108192;
